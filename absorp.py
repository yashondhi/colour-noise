...
triangle_xsml = [0., -1./math.sqrt(2.), 1./math.sqrt(2.)]
triangle_ysml = [math.sqrt(2./3.), -math.sqrt(1./6.), -math.sqrt(1./6.)]
...
xbounds, ybounds, surf = make_surf(spectrum, gr_abs, bl_abs, uv_abs, reps=10000)
